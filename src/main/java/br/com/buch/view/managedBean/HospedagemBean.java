...
public class HospedagemBean extends GenericBean<Hospedagem, ServiceHospedagem> implements Serializable{
	...
	// =======================METODOS DO USUARIO=====================================
		...
		public TipoFiltroHospedagem getFiltro() {
			return filtro;
		}

		public void setFiltro(TipoFiltroHospedagem filtro) {
			this.filtro = filtro;
		}

		public TipoFiltroHospedagem[] tipoFiltros(){
			return TipoFiltroHospedagem.values();
		}
